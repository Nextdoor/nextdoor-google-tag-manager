...

{
  ...
  "displayName": "Nextdoor Pixel",
  "brand": {
    "id": "brand_nextdoor",
    "displayName": "Nextdoor Pixel Template",
  ...
  "description": "The Nextdoor Pixel helps advertisers measure the effectiveness of campaigns.",
  "containerContexts": [
    "WEB"
  ]
}
